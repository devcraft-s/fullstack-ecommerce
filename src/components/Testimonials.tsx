...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="py-20 md:py-32 bg-gradient-to-b from-rose-50 via-pink-50 to-violet-50 dark:from-[#0a0a12] dark:via-[#0b1120] dark:to-[#0a0a12] relative overflow-hidden">
      {/* Background */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          >
            ...
            <span className="text-cyan-600 dark:text-cyan-400 text-sm font-medium">Client Stories</span>
          </motion.div>
        ...
        >
          <motion.div
            ...
            className="relative bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-white/10 p-8 md:p-12"
          >
            {/* Quote icon */}
            <motion.div 
            ...
            {/* Quote text */}
            <blockquote className="text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
            ...
            >
              <span className="text-cyan-600 dark:text-cyan-400 font-semibold">{testimonials[activeIndex].results}</span>
            </motion.div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="font-semibold text-gray-900 dark:text-white text-lg">{testimonials[activeIndex].name}</div>
              ...
              <div className="flex gap-2">
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="p-3 bg-gray-100 dark:bg-white/10 border border-gray-200 dark:border-white/10 rounded-xl hover:border-cyan-400/50 transition-colors text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white"
                >
            ...
            {testimonials.map((_, index) => (
              <motion.button
                ...
                className={`h-2 rounded-full transition-all duration-300 ${
                  activeIndex === index ? 'w-8 bg-gradient-to-r from-cyan-400 to-purple-400' : 'w-2 bg-gray-300 dark:bg-white/20 hover:bg-gray-400 dark:hover:bg-white/30'
                }`}
              />
            ))}
          </div>
